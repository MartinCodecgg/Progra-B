...
int main() {
    ...
    //Si tenemos que hacer un corte de control o enfrentamiento ya la forma alternativa de lectura no nos sirve
        ...
        while(!feof(binario)) {
            ...
            tempMin = 9999;
            tempMax = -9999;
            while(!feof(binario) && reg.ciudad == actCiudad) {
            ...
            printf("De la ciudad %s, el dia la menor temperatura registrada fue de: %f y la mayor registrada fue de f",actCiudad,tempMin,tempMax);
        }

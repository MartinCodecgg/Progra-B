...
// Crear el �rbol del ejercicio 22
...
int main() {
    ...
    printf("=== CREANDO �RBOL DE EJEMPLO ===\n");
    printf("Estructura del �rbol:\n");
    printf("        B(2)\n");
    printf("       /   \\\n");
    printf("     C(3)  D(5)\n");
    printf("          /|||||\\\n");
